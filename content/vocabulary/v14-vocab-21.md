...
A common error is to mix up 乗り場 with ホーム (platform). ホーム refers specifically to the trackside platform at a railway station: it is the wrong word for a bus bay or taxi stand. Using ホーム when directing someone to a バス乗り場 would send them looking for something that does not exist at that location. Additionally: staff should always specify the transport type when giving directions with 乗り場. Saying 「乗り場はあちらです」 is ambiguous if multiple transport modes are nearby. 「バスの乗り場」 or 「タクシーの乗り場」 makes the direction unambiguous.
