...
- **チェックイン日 (chekku-in bi)** — a near-synonym for 到着日 in hotel contexts; slightly more operational in tone, focusing on the administrative act of checking in rather than the physical act of arriving.
- **出発日 (shuppatsu bi)** — the counterpart to 到着日, marking when the guest departs; always confirmed alongside 到着日 to establish the full stay window.

## Common Mistakes

Learners sometimes use 到着日 and 宿泊日 interchangeably, but 宿泊日 can refer to any or all nights of the stay, while 到着日 is exclusively the first day. Another error is stating a time instead of a date when answering questions about 到着日 — for example, saying 「午後3時です」 when the question was about the date, not the time, which confuses the guest and creates a lookup mismatch in the system.

---

## Quiz

**A guest asks to arrive earlier than their booked date. Which term is relevant?**

- A. 到着日 (arrival date)
- B. 出発日 (departure date)
- C. 宿泊日 (stay date)
- D. 予約日 (reservation date)

**Correct Answer:** 到着日 (arrival date)

**Explanation:** 到着日 is the arrival-specific date — when a guest requests an early arrival, staff must check whether the room is ready from the previous night's check-out and communicate clearly about early check-in fees if applicable.
