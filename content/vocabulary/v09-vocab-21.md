...
"This plan allows free cancellation up to 7 days before your stay."
...
- **キャンセル料 (kyanseru ryou)** — The fee that applies once the 無料キャンセル window has passed. These two terms define the two sides of any cancellation policy, and staff should always explain them together: 〇日前までは無料キャンセルが可能ですが、それ以降はキャンセル料が発生いたします.
- **返金不可 (henkin fuka)** — "Non-refundable," the opposite extreme from 無料キャンセル. Some lower-priced plans are 返金不可, meaning no refund is issued upon cancellation regardless of timing. Knowing all three terms (無料キャンセル、キャンセル料、返金不可) allows staff to explain the full spectrum of cancellation policies.

## Common Mistakes

The most common and costly mistake is telling a guest that 無料キャンセル is available without specifying the deadline, which creates a false expectation of unlimited flexibility. Staff sometimes also fail to explain that the 無料キャンセル policy may differ by plan — the same hotel may offer 無料キャンセル on a flexible rate but 返金不可 on a discounted early-bird plan, and conflating the two causes serious disputes. Finally, learners sometimes use 無料 alone (e.g., 無料です) when asked about cancellation, which is ambiguous; the full phrase 無料キャンセルが可能です is always clearer and more professional.

---

## Quiz

**Guest asks: "Can I cancel my booking without paying?"**

- A. 無料キャンセル (free cancellation)
- B. キャンセル料 (cancellation fee)
