...
When a guest needs 通訳 help, one's first job is to clarify what kind they need: the language pair, the context, and whether a bilingual staff member can manage it or whether a certified professional is required. For a relaxed lobby conversation, a staff member with decent language skills is fine. For medical situations, legal matters, or complex business negotiations, a professional interpreter is the right call. Note: proactively offering this with 通訳が必要な場合はお申し付けください (please let us know if one needs interpretation) is far better than waiting for a guest to struggle visibly and then reacting\n## Example Sentences
