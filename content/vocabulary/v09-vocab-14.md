...
"If you use our early-bird plan, you will receive a 20% discount off the standard rate."

**2.** 会員様には10％の割引が適用されます。
*Kaiin-sama ni wa juu-paasento no waribiki ga tekiyou saremasu.*
"A 10% discount is applied for members."

**3.** 割引後の金額は合計で15,000円でございます。
...
Learners sometimes confuse 割引 with 値引き and use the two interchangeably, but in a hotel context 値引き can sound informal or suggest that the guest has haggled, which is inappropriate. Another common error is stating only the final price without explaining the original rate, which deprives the guest of understanding what they saved; always use the full construction 通常〇円のところ〇円割引で〇円でございます. Finally, staff occasionally omit the percentage or amount of the discount, simply saying 割引があります, which is too vague to be useful.

---

## Quiz

**Guest asks about early booking price reduction. Which term applies?**

- A. 割引 (discount)
- B. 追加料金 (additional charge)
