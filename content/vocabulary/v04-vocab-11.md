...
A very common oversight is restocking シャンプー without checking whether コンディショナー also needs replenishing. They sit right next to each other, so staff should check both while servicing the room. When telling a guest where the コンディショナー is, staff should be specific: シャワー横 (beside the shower) or シンク横 (beside the sink) is far more helpful than a vague gesture toward the bathroom. This loanword is also frequently mispronounced or misspelled as コンデショナー or コンデイショナー. The correct form is コンディショナー, with a clear short イ in the middle.
