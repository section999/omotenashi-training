...
A common error is to mix up 通報 and 報告, but the direction of communication sets them apart. 通報 goes outward to official authorities; 報告 goes inward to supervisors. Using the wrong one in a report or debrief can create confusion about what happened. Another mistake is hesitating to make a 通報 because of uncertainty about whether a situation qualifies as an emergency. Hotel policy should be unambiguous: when in doubt, contact emergency services immediately. The mistake most likely to cause harm is waiting too long. Additional drill during training: staff should practise saying the hotel's full Japanese address aloud at speed, because address formats in Japan differ from Western conventions, and the stress of a real emergency is not the time to get confused about street numbers and ward names.
...
**Question:** Reporting an emergency to authorities is called ____ in Japanese.
