...
A frequent mistake is approaching the table before the guest has had enough time to read through the menu, which creates pressure rather than comfort. Using 注文は？ without the honorific ご is too abrupt and inappropriate in a hotel restaurant. The most commonly overlooked step is the confirmation itself: some staff take the order and immediately walk away without repeating it back, and that is where errors happen. The order should always be repeated; guests generally appreciate the thoroughness rather than finding it excessive.
