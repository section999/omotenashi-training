...
Learners sometimes use シャワー as a verb directly, saying 「シャワーしてください」, but the natural phrasing is 「シャワーをお使いください」 or 「シャワーをお浴びください」. Another common error is omitting polite forms when explaining room equipment; staff should always use ございます or でございます rather than plain です/ある forms. Confusing シャワー (shower) with お風呂 (bath) when responding to guest questions about bathing facilities can also cause misunderstandings.
