...
title: 入国 (nyuukoku)
---
入国 reads as "entering a country," and it refers to the formal process of being admitted into Japan through an immigration checkpoint. This involves presenting a valid passport, completing an arrival card (mostly digital now), passing biometric screening at major international airports, and receiving an entry stamp or status confirmation. For hospitality staff, the key thing to understand about 入国 is that it is a prerequisite: a guest cannot legally begin their stay until this process is complete, which means issues at the immigration counter can directly affect the check-in desk.
...
A common error is to confuse 入国 with 入室 (nyuushitsu, entering a room) or 入店 (nyuuten, entering a shop). The shared character 入 means "enter," but the second character tells staff what is being entered: 国 is "country." Once that is locked in, the compound makes complete sense. Another mix-up is treating 入国 and 入国審査 as synonyms: 入国審査 is the screening check specifically, while 入国 is the broader act of crossing into Japan. Additionally: 入国 is always about crossing a national border. Staff would not use it to describe entering a building or venue.

---

## Quiz

**The act of entering a country is called:**

- A. 出国 (departure from the country)
- B. 入国 (entry into the country)
- C. 通貨 (currency)
- D. 観光地 (tourist destination)
