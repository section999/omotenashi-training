...
A common error is reaching for 開店時間 (kaiten jikan, shop opening time) or simply 時間 (jikan, time) when 利用時間 is intended. In hospitality, using the right term matters -- it signals to the guest that the staff member knows the space they are working in. Additionally: times should always be qualified with 午前 (gozen) or 午後 (gogo) when speaking. Saying "seven o'clock" without clarifying AM or PM confuses guests, and that confusion creates a poor impression.
