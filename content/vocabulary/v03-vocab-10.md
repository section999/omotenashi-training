...
Responding to pillow requests with vague language like 後ほど (later) without any timeframe leaves guests guessing and feeling uncertain. A specific time should be given, or immediate action should be taken. Another common slip is confusing 枕 with クッション (kusshon, cushion), which refers to decorative or sofa cushions, not sleeping pillows; using the wrong word causes confusion for both staff and guest. Mentioning the pillow menu at check-in before any discomfort arises, rather than waiting for a complaint, is more in the spirit of omotenashi.
