...
|---|---|
| ご確認いただけますでしょうか<br>go-kakunin itadakemasu deshō ka | "Could I ask you to confirm?": softer, more question-form version for spoken use |
| 内容をご確認の上<br>naiyō wo go-kakunin no ue | "After confirming the contents": formal connector used in written communication |
| お間違いはございませんか<br>o-machigai wa gozaimasu ka | "Is there anything incorrect?": an alternative way to invite review of details |
