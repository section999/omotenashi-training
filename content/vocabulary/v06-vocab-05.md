...
Learners sometimes use 修理してください (please repair it) directly to a guest, which reverses the roles — it sounds as though the staff is asking the guest to handle the repair. The correct guest-facing phrase is always the formal acceptance: 修理依頼を承ります. Additionally, staff should avoid giving specific repair timeframes unless they are certain, as promising "ten minutes" and then taking an hour damages trust far more than a cautious 少々お時間をいただきます (it will take a little time).
