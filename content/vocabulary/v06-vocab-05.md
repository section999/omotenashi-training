...
In practice, 修理依頼 works in both spoken and written contexts. Staff at the front desk typically log the request in the maintenance system, communicate the timeline to the guest, and follow up after the repair is completed. The word 承ります (uketamawarimasu) is the most appropriate response phrase, as it commits the hotel to action while remaining suitably humble. If a repair cannot be completed right away, offering alternatives, a room change, a loan of replacement equipment, is standard practice in professional service recovery. Don't just leave the guest waiting without options.
...
Students sometimes say 修理してください (please repair it) directly to a guest, which sounds as though the staff member is asking the guest to handle the repair themselves. The correct guest-facing phrase is always the formal acceptance: 修理依頼を承ります. Another pitfall is giving specific repair timeframes when you cannot actually guarantee them. Promising "ten minutes" and taking an hour is far more damaging to trust than a careful 少々お時間をいただきます (it will take a little time). When in doubt, give a slightly wider estimate and then deliver early.

---

## Quiz

**Guest says: "The TV is not working." Best response?**

- A. 修理依頼を承ります (we will accept your repair request)
- B. 係の者が後ほどお伺いいたします (staff will visit you later)
- C. 新しいお部屋へご移動いただけますか (would you be able to move to a new room?)
- D. ご不便をおかけして大変申し訳ございません (we are very sorry for the inconvenience)
