...
The real skill here is not just knowing that the fee exists. one needs to be able to explain the specific tiers attached to the プラン: when the charges start, what percentage applies at each stage, and what the actual yen amount will be. A statement like 「キャンセル料は、宿泊日の3日前から発生いたします。前日は50%、当日は100%の料金をいただきます」 gives the guest a clear picture before they confirm, so they are making an informed decision rather than agreeing to something they did not fully read\n## Example Sentences
