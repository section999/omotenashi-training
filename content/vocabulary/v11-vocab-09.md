...
不在 tells a caller that the person they need is not available right now. In the world of Japanese hospitality telephone etiquette, though, 不在 is never the end of a sentence, it is always the beginning of one. The moment one says 担当者はただいま不在でございます, one's next breath should already be offering an alternative. That reflex distinguishes a trained hotel professional from someone just reporting facts. The guest's need does not disappear because one staff member is away, and omotenashi demands one respond to that need regardless.

不在 can cover anything from "stepped away from the desk for two minutes" to "out of the office on annual leave." those two situations call for very different follow-up offers. If the 担当者 is briefly on another floor, one can offer a hold or a quick callback. If they are off for the day, one needs to offer a colleague who can help. Getting this distinction right matters, because an inaccurate time estimate is almost as bad as offering no help at all. Note: 不在 also appears in the compound 留守番電話 (voicemail), which reads as "telephone for guarding the house in one's absence", a vivid image that hints at why the word carries such a sense of responsibility\n## Example Sentences
