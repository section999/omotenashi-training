...
不在 can cover anything from "stepped away from the desk for two minutes" to "out of the office on annual leave." In practice, those two situations call for very different follow-up offers. If the 担当者 is briefly on another floor, you can offer a hold or a quick callback. If they are off for the day, you need to offer a colleague who can actually help. Getting this distinction right matters, because an inaccurate time estimate is almost as bad as offering no help at all. Worth noting: 不在 also appears in the compound 留守番電話 (voicemail), which reads as "telephone for guarding the house in one's absence", a vivid image that hints at why the word carries such a sense of responsibility.
