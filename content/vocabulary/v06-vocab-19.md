...
**2.** ロビーのコーヒーは無料にてご提供しております。どうぞご自由にお召し上がりください。
...
**3.** 空港シャトルバスのご利用は無料でございますが、事前のご予約が必要でございます。
