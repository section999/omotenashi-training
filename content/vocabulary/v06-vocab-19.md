...
A common mistake is answering a guest's question about cost with just 「はい、無料です」. While technically correct, plain-form です is too casual for a formal hotel environment. 「無料でございます」 is what guests expect to hear. A common error is to also forget to mention whether tax is included (税込み) when discussing pricing, and that omission can create confusion at checkout. 無料 should not be confused with 無償 (mushoo), which is a more formal or legal term meaning "without compensation," used in contracts rather than spoken conversation. In guest-facing hospitality, 無料 is the correct word.
