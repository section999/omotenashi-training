...
A common mistake is listing アメニティ items at check-in without following up with an invitation to request more. Saying only 「アメニティがあります」 without the closing 「お申し付けください」 loses the welcoming tone that omotenashi requires. A common mistake is being vague about exactly what is and is not included, which can leave guests discovering missing items only after staff have left. In properties transitioning to eco-friendly bulk dispensers, there is an additional important point: staff should explain the change proactively so guests understand why individual items may not be present.
...
**ご滞在中の必要な____はお申し付けください。
(Please request any amenities you need during your stay.)**

- A. アメニティ (amenities)
- B. 清掃 (cleaning)
- C. 交換 (exchange / replacement)
- D. ルームサービス (room service)
