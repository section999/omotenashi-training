...
Confusing 禁煙 and 喫煙 when recording or communicating room preferences is the most serious error in this area. The two words are similar enough that a moment of carelessness results in the opposite room being assigned. Another common slip is saying only 禁煙でございます when referring to a specific room; the fuller 禁煙室でございます is clearer and more precise. The single character 室 (shitsu, room) is important. A guest's preference should not be assumed based on appearance or other assumptions. The preference should be asked explicitly every time.
