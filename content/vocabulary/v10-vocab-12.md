...
**Explanation:** 請求書 formally notifies a client of what is owed and when payment is due, and it always comes before money changes hands. 領収書 comes after payment and proves it was received; 明細書 shows what was charged; and 内訳 is the itemized breakdown within a billing document. Reversing the 請求書 and 領収書 sequence creates a false record in the client's accounting system and makes it difficult to follow up on an unpaid balance without a correction.
