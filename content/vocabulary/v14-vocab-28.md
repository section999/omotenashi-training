...
One phrase that works well in these situations is 「日本では～という習慣があります」, which translates naturally as "In Japan, there is a custom of..." It's informative without being preachy, and it signals to the guest that one is inviting them into local culture, not scolding them. However, it's good to remember why these customs exist, because the explanation lands much better when it comes with a little context. Understanding where a 習慣 comes from helps both one and one's guest appreciate it more deeply\n## Example Sentences
...
**Question:** Social habits or traditional practices are called ____ in Japanese.
