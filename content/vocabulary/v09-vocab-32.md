...
One key mistake is treating 直前予約 with the same urgency level as a regular 当日予約. They are not the same. A morning same-day booking for a 3 PM check-in allows more preparation time. A 直前予約 made at 2 PM for a 4 PM arrival does not. Delaying notification to housekeeping can result in a guest waiting at the front desk for a room that is not ready. Staff should ask for the estimated arrival time when accepting a 直前予約, because that information determines how quickly everything else needs to proceed. Staff should not quote a promotional rate that has advance-booking conditions attached; they should confirm that the rate is valid for last-minute reservations before stating a price to the guest.
...
**Guest books two hours before arrival. Which term applies?**

- A. 直前予約 (last-minute reservation)
- B. 当日予約 (same-day reservation)
