...
- **当日予約 (toujitsu yoyaku)**: same-day reservation, the broader category that includes 直前予約. A 当日予約 made in the morning for an evening check-in can allow several hours for preparation. 直前予約 implies the guest is arriving very soon, which changes one's urgency level entirely.
