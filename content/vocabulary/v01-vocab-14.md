...
- **失礼いたします (shitsurei itashimasu)**: "Excuse me", similar function but one step below *osore irimasu* in formality; this is the phrase one will reach for most often in everyday professional situations, and that is completely fine
...
- **とんでもございません (tondemo gozaimasen)**: "Not at all / one is too kind", the natural companion phrase when a guest praises one or one's service; it deflects rather than accepts
