...
The key thing to understand is that *osore irimasu* is always about humbling oneself relative to the other person. When staff say it before asking a guest's name, one is acknowledging that even asking is a small imposition, and one is lowering oneself before doing so. This phrase sits above both *sumimasen* and *shitsurei itashimasu* on the formality scale. Relying only on *sumimasen* means missing an entire register. It is like knowing "sorry" in English but not knowing "I beg their pardon" or "please forgive the intrusion."
