...
シングルルーム is defined by bed count, not occupancy limits; some properties do allow two occupants for a supplementary charge. Shortening it to just シングル is acceptable in staff conversations, but in front of guests the full term シングルルーム sounds more polished and professional. A common error is assuming a guest booking a シングルルーム is travelling alone; acting on that assumption can lead to a comment that catches the guest off guard.
