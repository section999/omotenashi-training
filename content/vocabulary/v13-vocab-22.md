...
- **担当者 (tantousha)** — "the person in charge," the noun form used when referring to the individual responsible; often heard in phone calls and internal communications
- **ご担当 (go-tantou)** — the honorific form, used when referring to the person in charge of a guest's account or services in a respectful context

## Common Mistakes

Learners sometimes confuse 担当 with 責任者 (sekininsha — person responsible / manager on duty). While both imply responsibility, 担当 is about being assigned to something specific, whereas 責任者 carries higher authority and is called upon when decisions need to be escalated. Another mistake is writing 担当 as a standalone greeting without context — always pair it with enough information to clarify what the person is 担当 for (e.g., 予約担当の〇〇と申します — "I am 〇〇, in charge of reservations").
