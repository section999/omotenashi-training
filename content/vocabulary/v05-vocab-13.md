...
Telling a guest 空いている席はあそこです and pointing is a mistake in Japanese hospitality. Guests are always led to their seats, not pointed toward them. This is widely known as a rule but easy to revert to under pressure. Another common slip is using the plain form 席が空いてます, which is understandable but lacks the formal polish a hotel restaurant requires. When seating options exist, a choice should be offered: "Would you prefer the window table or one closer to the centre?" is a small gesture that personalises the experience, and guests notice and appreciate it.
