...
- **満席 (manseki)** — the antonym, meaning all seats are taken; the two terms are naturally paired when explaining the current seating situation to guests.
- **ご案内 (go-annai)** — the act of guiding a guest to their seat; always paired with aiteiru seki in the seating process and expressed humbly as ご案内いたします.

## Common Mistakes

A common error is telling a guest 空いている席はあそこです and pointing without personally escorting them — in Japanese hospitality, guests are always led to their seats, not simply pointed in a direction. Staff sometimes use the plain form 席が空いてます which, while understandable, lacks the formal polish expected in a hotel restaurant. Forgetting to offer a choice of seating (window vs. interior, booth vs. open table) when options exist misses an opportunity to personalize the experience.
