...
**こちらのお客様は3連泊のご予定でございますので、ハウスキーピングに申し伝えます。**  
...
**三日間続けて宿泊する場合、____です。
(Staying three consecutive nights is called a consecutive-night stay.)**

- A. 連泊 (consecutive nights / multi-night stay)
- B. 滞在 (stay)
- C. 宿泊日 (stay date)
- D. 何泊 (how many nights)
