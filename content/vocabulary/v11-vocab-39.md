...
- **もう一度おっしゃっていただけますか (mouichido osshatte itadakemasu ka)** — a more formal and respectful variant using the honorific verb おっしゃる; appropriate for luxury hotel contexts where every word is carefully chosen
- **復唱します (fukushou shimasu)** — "I will repeat it back"; the follow-up phrase used after receiving repeated information to confirm accuracy, completing the communication loop

## Common Mistakes

Learners sometimes use もう一度言ってください instead of もう一度お願いします or もう一度おっしゃっていただけますか — while grammatically correct, 言ってください (please say) uses a plain imperative form that sounds too direct and even slightly rude on a professional hotel line. Another error is forgetting to read back the information after asking for repetition, which defeats the purpose of the clarification. Staff should also avoid repeating the request more than twice without offering an alternative such as calling back or asking the guest to spell out information phonetically, as repeated requests can frustrate callers.
