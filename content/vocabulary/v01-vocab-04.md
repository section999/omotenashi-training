...
The phrase has the same structural origin as *konnichiwa* — both were once part of longer expressions about how "today/tonight is going" — but in modern use it functions as a simple, sincere evening acknowledgement. Use it whenever the sun has set or when the context clearly feels like evening, even if the strict clock hour is ambiguous.
...
The most common timing error is using *konbanwa* too early — in late afternoon when it is still clearly daytime. Conversely, some staff continue using *konnichiwa* well into the evening out of habit. Pay attention to the light, the hour, and the atmosphere. Also note that *konbanwa* is a greeting (said when seeing someone), while *oyasumi nasai* is a farewell (said when parting at night) — they are not interchangeable.
