...
- **精算 (seisan)** — 精算 refers to the broader act of settling a bill or final account, often used for hotel checkout or accumulated charges, whereas レジ refers specifically to the physical counter where payment is made.
- **会計 (kaikei)** — 会計 means the act of paying or the accounting function; a guest might say お会計をお願いします to request the bill, and staff would then direct them to the レジ to complete it.

## Common Mistakes

Learners sometimes use レジ and 会計 interchangeably, but レジ refers to the machine or counter while 会計 refers to the payment act itself. Avoid saying レジをお願いします when you mean to ask a guest if they are ready to pay — instead say お会計はよろしいでしょうか. Additionally, staff should never just gesture toward the レジ in a premium setting; escorting the guest is the hospitality standard.
