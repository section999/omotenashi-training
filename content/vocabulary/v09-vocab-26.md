...
- **満室 (manshitsu)**: "fully booked," the state where 空き状況 has reached zero. Use 満室 only after confirming through the system. When it does apply, offer an alternative date or suggest a nearby sister property rather than leaving the guest with a dead end.
