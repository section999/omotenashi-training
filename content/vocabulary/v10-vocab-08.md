...
"As you can see from the breakdown, the dining charges and room service fees are listed separately."
...
- **明細書 (meisaisho)** — itemized statement; a more formal document version of the 内訳, often issued for corporate or accounting purposes.
- **合計 (goukei)** — the total that results from the 内訳; always presented after the breakdown has been reviewed, not before.

## Common Mistakes

Learners sometimes skip offering the 内訳 and jump directly to stating the 合計, which can leave guests feeling they have no opportunity to verify the charges. Another common mistake is presenting the 内訳 as a finished document without inviting the guest to ask questions, which can feel perfunctory rather than genuinely helpful. Staff should be careful not to confuse 内訳 with 明細書 — the 内訳 is the structured breakdown itself, while 明細書 is the formal document that contains it.

---

## Quiz

**Which shows detailed itemized charges?**
