...
Learners sometimes use クレーム when a simple 問題 would be more appropriate, unnecessarily heightening the formality or urgency of the situation. Conversely, downgrading a legitimate クレーム to mere 問題 can make the guest feel unheard. Staff must also avoid the phrase クレームは受け付けません (we do not accept complaints), which is not only dismissive but highly damaging to the hotel's reputation — all complaints must be received graciously regardless of their perceived validity.
