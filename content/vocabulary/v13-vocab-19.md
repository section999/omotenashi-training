...
A common error is reach for 質問があります (shitsumon ga arimasu: "I have a question") when they need 相談. A 質問 asks for a specific fact, while 相談 opens a conversation to work through a problem together. Using 質問 when one needs advice signals that one just want a quick answer, and one's colleague or supervisor may respond accordingly with a short reply rather than genuine guidance. Also, the honorific prefix ご belongs in front of 相談 whenever one is speaking to a guest or a superior; dropping it makes the phrase sound like casual internal chatter, which is not the right register for either situation.
