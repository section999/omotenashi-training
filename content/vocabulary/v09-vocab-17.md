...
- **朝食付き (choushoku tsuki)** — The most immediate contrast with 素泊まり: a plan that adds breakfast. When guests ask whether they can add breakfast to a 素泊まり booking, staff should confirm whether this is possible and at what additional charge, using the term 朝食付きプランへの変更 (a change to the breakfast-included plan).
- **一泊二食 (ippaku nishoku)** — This phrase means "one night with two meals" (breakfast and dinner included) and represents the opposite end of the meal-inclusion spectrum from 素泊まり. It is the standard offering at most traditional ryokan and is worth knowing as a benchmark when explaining the range of plan options.

## Common Mistakes

Learners sometimes introduce 素泊まり with apologetic language that makes it sound like a lesser or inferior option, which is unnecessary and can embarrass guests who chose it deliberately. Another mistake is failing to mention meal alternatives when confirming 素泊まり, which misses the omotenashi opportunity to assist proactively. Staff occasionally also confuse 素泊まり with 朝食なし (no breakfast), but 素泊まり means no meals at all — confirming there is no dinner either is important, especially at ryokan where guests may assume dinner is always included.

---

## Quiz

**朝食は含まれていないので、____プランです。
(Since breakfast is not included, it is a room-only plan.)**

- A. 素泊まり (room only (no meals))
- B. 朝食付き (breakfast included)
- C. 夕食付き (dinner included)
- D. 特典 (benefit / privilege)
