...
"The elevator is immediately to your left as you enter the main entrance."
...
- **エスカレーター (esukareetaa)** — an escalator; found in department stores and large hotel lobbies, but less common in guestroom areas; use when directing guests to a specific floor in a retail or public-facing context.
- **階段 (kaidan)** — stairs; always the correct alternative during emergency evacuations and sometimes preferred by guests for short distances; never recommend elevators during a fire drill or emergency.

## Common Mistakes

Learners sometimes use plain-form directions like 「エレベーターに乗ってください」 which sounds abrupt; the more refined 「エレベーターでお上がりください」 or 「エレベーターをご利用くださいませ」 better suits a formal hospitality context. Another common error is failing to mention floor restrictions or keycard requirements upfront, which can cause confusion and frustration for guests. Finally, do not forget that エレベーター takes the particle で (means of travel) rather than に when explaining how to reach a floor.

---

## Quiz

**A guest asks: "How do I get to the 10th floor?"**

- A. エレベーターで10階までお上がりください (please take the elevator to the 10th floor)
- B. 階段で行ってください (please take the stairs)
- C. 分かりません (I don't understand)
- D. エレベーターはバックヤードのみご利用できます (the elevator is available for staff area only)
