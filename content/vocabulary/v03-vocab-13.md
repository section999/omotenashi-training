...
- **バスタオル (basu taoru)**: bath towel; larger and thicker, used after bathing. Make sure to distinguish it from タオル when responding to guest requests so one deliver the right item every time.
