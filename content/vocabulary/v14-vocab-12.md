...
A mistake that is easy to fall into is using おすすめ insincerely. Guests are surprisingly good at detecting a scripted recommendation, and when they sense that, the trust built disappears quickly. If staff do not have a personal favourite to offer, it is better to ask a colleague who does than to make something up. Note also: おすすめ is a recommendation made for someone else's benefit, while お気に入り (okiniiri) is a personal favourite. These are different, so staff should keep them straight. When speaking formally to guests, staff should use ご おすすめ or お勧めいたします rather than the plain form to maintain the right level of politeness.
