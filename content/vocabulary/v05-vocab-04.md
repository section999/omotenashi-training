...
The most common error is using 晩ごはん with guests, which immediately breaks the formal tone expected in hospitality. Staff sometimes announce only the dinner start time and neglect to mention the last order time, which can lead to guests arriving too late. Another mistake is failing to personalize the communication — simply saying 夕食は6時です is informative but misses the opportunity to express anticipation and care that omotenashi demands.
