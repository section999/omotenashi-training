...
title: トラブル (toraburu)
---
トラブル (toraburu), borrowed from the English word "trouble," refers to unexpected incidents or disruptions that interfere with a guest's comfort or experience. It comes up in both internal staff communication and direct guest-facing speech when a situation warrants clear urgency: a noisy neighbouring room, a technical failure, a service delay. The word carries emotional weight. In the omotenashi tradition, how one responds to トラブル matters as much as what staff do, because a composed reaction reassures the guest and prevents panic from making things worse.
...
A common error is using トラブル in positive or neutral contexts, the word always implies something has gone wrong. Saying 「トラブルはありません」 (there is no trouble) is grammatically fine but sounds defensive: professional service language avoids the word unless an issue already exists. Staff should also resist using the English word "trouble" directly in guest speech; the Japanese loanword トラブル is more appropriate and sounds more natural in the hospitality register.
...
**Guest reports an issue in the room. What do you say first?**

- A. トラブルについてお伺いいたします (I will ask about the issue)
- B. 少々お待ちください。上の者をお呼びいたします (please wait; I will call my superior)
- C. 後ほど確認いたします (we will check later)
- D. ご不便をおかけして申し訳ございません (we are sorry for the inconvenience)

**Correct Answer:** トラブルについてお伺いいたします (I will ask about the issue)

**Explanation:** トラブルについてお伺いいたします is the right first step because it shows you are listening before jumping to solutions, which is exactly what a guest who has just reported a problem needs to feel heard. Calling a superior, promising to check later, or apologising before you know the details all skip the essential step of gathering information, which お伺いいたします, the deeply humble form of "to hear," is designed to do.
