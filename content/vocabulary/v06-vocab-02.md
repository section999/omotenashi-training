...
A common error is using トラブル in positive or neutral contexts — the word always implies something has gone wrong. Saying 「トラブルはありません」 (there is no trouble) is grammatically fine but sounds oddly defensive: good service language avoids the word unless an issue already exists. Staff should also resist using the English word "trouble" directly in guest speech; the Japanese loanword トラブル is more appropriate and sounds more natural in the hospitality register.
