...
title: 入口 (iriguchi)
---
入口 (入口) reads as "entry opening" and is the standard Japanese word for entrance. In a hospitality context, knowing and communicating this word precisely is essential because large properties, hotels, convention halls, ryokan, typically have multiple entrances serving different purposes: a main guest entrance, a service entrance, a parking entrance, and an emergency exit. Guests who approach the wrong staff may feel confused or unwelcome, so clear, proactive guidance is a core part of omotenashi. Staff are expected not just to answer when asked, but to anticipate navigation needs and offer entrance directions as part of the greeting sequence.
...
**ホテルの入口は正面にございます。どうぞこちらへお進みください。**  
...
**レストランのお客様用入口はこちらでございます。スタッフ用は裏口をご利用ください。**  
