...
- **無料 (muryou)** — The direct opposite, meaning free of charge. Staff must be equally fluent in both terms to set correct expectations across different services. In a single check-in explanation, both words may be necessary: Wi-Fi is 無料, but room service is 有料.
- **別途料金 (betto ryoukin)** — Meaning "separate/additional charge," this phrase is used when a base service is included but an add-on incurs an extra fee. It is more specific than 有料 alone and is appropriate when a guest might assume an extension of an already-paid service is included.

## Common Mistakes

A critical mistake is failing to disclose 有料 before a guest uses a service, leaving them surprised at checkout — this single omission can generate complaints and negative reviews regardless of how flawless the rest of the stay was. Learners sometimes also confuse 有料 with 料金 (ryoukin, the fee amount itself); 有料 describes the status of being chargeable, while 料金 refers to the actual price. Finally, using casual forms like 「お金かかります」 instead of 「有料でございます」 in formal guest interactions is inappropriate and sounds unprofessional.
...
- A. 有料 (paid / chargeable)
- B. 無料 (free of charge)
- C. 無理 (impossible / not feasible)
- D. 利用 (use / usage)
