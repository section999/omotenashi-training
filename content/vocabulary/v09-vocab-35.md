...
- **団体予約 (dantai yoyaku)**: group reservation; the contrasting booking type that requires coordinated multi-room management and a dedicated group coordinator, as opposed to the one-to-one service model of 個人予約.
- **リピーター (ripeetaa)**: repeat guest; individual guests who return to the same hotel are among the most important 個人予約 guests, and personalized service based on their history is the hallmark of excellent omotenashi.

## Common Mistakes

A common error is treating 個人予約 as inherently simple and therefore giving it less attentive handling than group bookings. In reality, individual reservations are where the most memorable moments of hospitality occur: a small gesture or recalled preference can transform a guest into a loyal リピーター. Learners sometimes also fail to access the guest history profile when a 個人予約 arrives, missing the opportunity to apply stored preferences automatically. Every 個人予約 check-in should begin with pulling up the guest record to check for notes, past complaints, VIP status, and preferences before the guest reaches the desk, so that the greeting feels personal rather than transactional.
...
**一人または少人数の予約は____です。
(A reservation for one or a small group is an individual reservation.)**

- A. 個人予約 (individual reservation)
- B. 団体予約 (group reservation)
- C. 連泊 (consecutive nights / multi-night stay)
- D. 仮予約 (tentative reservation)
