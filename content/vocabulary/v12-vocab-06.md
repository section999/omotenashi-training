...
- **非常ベル (hijou beru)** — emergency bell; the physical alarm device that produces the sound component of a 警報; the 非常ベル is the hardware while 警報 describes the alert signal or state.
- **警告 (keikoku)** — warning; a stronger verbal or written caution directed at a specific person or situation, whereas 警報 is typically a broadcast signal to all occupants of a space simultaneously.

## Common Mistakes

Learners sometimes confuse 警報 (broad alarm or alert signal) with 警告 (a directed verbal or written warning to an individual), using them interchangeably in contexts where the distinction matters. Another mistake is failing to act on a 警報 because staff assume it is a false alarm — property policies should always require investigation before an all-clear is given. Staff should also avoid silencing an alarm manually before confirming the cause, as this can deprive other building occupants of the warning signal they need.
