...
- **地下 (chika)**: the general, non-specific term for "basement"; appropriate only when there is a single basement level or when the exact level is unknown; always prefer 地下一階 when one knows the specific floor

## Common Mistakes

The most critical error is pronouncing 地下一階 as chika-ichi-kai; the correct reading is chika-ikkai, following the double-k pattern of other 一階 compounds. Directing guests to 地下 without specifying the B1 elevator button is also common; staff should mention the button alongside the floor name. Confusing 地下一階 with 地下二階 in a building with multiple basement levels is a navigational error that wastes guest time and reflects poorly on the property.

---

## Quiz

**Guest asks: "Where is the gym?"**

- A. 地下一階です (it is the basement floor)
- B. 一階です (it is the first floor)
- C. 二階です (it is the second floor)
- D. 最上階です (it is the top floor)
