...
- **紅茶 (koucha)** — black tea, the most common alternative to coffee after meals; when offering コーヒー, it is courteous to mention 紅茶 as an option simultaneously for guests who do not drink coffee.
- **カフェイン抜き (kafein nuki)** — decaffeinated; important vocabulary when attending to guests who request coffee but indicate sensitivity to caffeine, particularly in the evening.

## Common Mistakes

A common error is offering コーヒー without offering an alternative, which can leave non-coffee-drinking guests feeling excluded. Staff sometimes forget to ask about hot versus iced preference and bring hot coffee by default, which can disappoint guests expecting cold brew or iced coffee. Additionally, using 飲みますか (do you want to drink?) instead of the polite いかがでしょうか is too blunt and drops the soft, inviting quality expected in formal service.
