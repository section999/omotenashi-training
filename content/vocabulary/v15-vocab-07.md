...
When explaining how to set up the board, keep it practical: place it on a stable surface, extend the legs fully, and point the narrow tapered end away from one. Some guests, particularly those travelling from countries where ironing boards are less common, may need that brief walk-through. Additionally, to check during room prep: the cover. A scorched or dirty cover can transfer marks directly onto a guest's shirt, which is the last thing anyone wants\n## Example Sentences

**1.** アイロン台はクロゼット内の上段にございます。ご不明な点はフロントまでどうぞ。
...
**2.** アイロン台をご使用の際は、安定した場所に広げてからお使いください。
...
**3.** ただいまお部屋にアイロン台がない場合は、すぐにお持ちいたしますのでお申し付けください。
