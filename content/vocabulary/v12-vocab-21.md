...
**2.** エレベーターが点検中のため、こちらの階段をご利用くださいますようお願いいたします。
...
**3.** 点検中のジムの機器は、本日午後3時より再度ご利用いただけます。
...
**You see a sign indicating maintenance is ongoing. What does it say?**

- A. 使用禁止 (prohibited)
- B. 点検中 (under inspection)
