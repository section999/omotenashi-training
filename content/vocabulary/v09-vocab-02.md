...
予約日 is the calendar date on which the guest made their reservation, as distinct from the dates of the actual stay. A common error is to treat this as a minor detail, but in Japanese hotel operations the 予約日 carries real weight. Many promotional rates, early booking discounts (早割), and membership perks are calculated based on how far in advance a reservation was placed, which means the 予約日 directly affects billing accuracy. Revenue managers and auditors also rely on it when tracking booking trends, evaluating marketing campaign performance, and checking for duplicate or suspicious entries. Knowing the difference between 予約日 and 宿泊日 is one of the first distinctions expected of new front-desk staff, and it comes up more often than one might expect.
...
- **到着日 (touchaku bi)**: specifically the first day of arrival within a multi-night stay; useful when one needs to identify the check-in date precisely rather than referring to the entire stay window


## Common Mistakes

The most frequent error is using 予約日 and 宿泊日 as if they mean the same thing. A guest who booked in January for an April stay has a January 予約日 and an April 宿泊日, and conflating the two can result in misapplied discounts or records that cannot be found. A common error is to write 予約した日 (the informal past-tense verb phrase) in formal correspondence instead of the noun 予約日. The meaning comes across, but it registers as too casual for professional hospitality communication and can undermine the guest's confidence in the precision of one's operation.
...
**Guest asks: "When did I make this reservation?" Which term covers this?**

- A. 予約日 (reservation date)
- B. 宿泊日 (stay date)
- C. 到着日 (arrival date)
