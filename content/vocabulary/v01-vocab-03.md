...
Note that the time window for *konnichiwa* is genuinely important in Japanese social culture. Greeting someone with *konnichiwa* in the early morning or after dark signals a lack of attentiveness to context — the kind of small slip that an experienced hospitality professional avoids.
...
The biggest mistake is confusing the time window — using *konnichiwa* in the morning or after dark. A second common mistake for non-native speakers is mispronouncing the particle は as *ha* — it is always pronounced *wa* in this phrase. Finally, resist using the casual abbreviation *konchi* (コンチ) in any professional setting.
