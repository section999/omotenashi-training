...
上司 means boss or supervisor, the person above one in the workplace hierarchy who oversees their performance and gives instructions. In Japanese hospitality culture, the relationship between an employee and their 上司 is built on respect, clear communication, and a strong sense of duty. A common point of confusion: when referring to their superior in conversation with a third party, 上司 is the natural word to use, but it is not used when addressing them directly. When speaking to them, staff would use their name with さん, or their title, 部長, 支配人, and so on.
