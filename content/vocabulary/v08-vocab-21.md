...
In a hospitality context, 近くに on its own is not enough. Always follow it with a walking time: コンビニはホテルの近くに、徒歩約3分のところにございます gives the guest something actionable. The most effective structure is three-layered: 近くに sets the tone, 徒歩〇分 gives the time, and a landmark reference seals it. Ryokan staff use the same structure when pointing guests toward a nearby temple or onsen source, so this pattern travels across property types.
...
- **遠くに (tooku ni)**: Far away, the opposite of 近くに. Using 遠くに honestly when a destination is genuinely far builds more trust than understating the distance. If something is a 20-minute walk, say so.

## Common Mistakes

The most common slip is using 近くに without adding a distance estimate afterward. A guest who hears 近くにございます but gets no follow-up has no idea whether "nearby" means two minutes or fifteen, and that ambiguity causes frustration. Always tie it to 徒歩〇分 or a landmark. Learners also sometimes drop the に and say 近く alone, which sounds grammatically incomplete in a full sentence. If a place is literally next door, 近くに understates the proximity and could send the guest walking past it looking for something farther away — when it is truly 隣, use 隣に.
