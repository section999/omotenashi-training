...
**3.** 徒歩では遠くにございますので、シャトルバスのご利用はいかがでしょうか。
...
The most problematic mistake is avoiding 遠くに out of a desire to be encouraging, and instead saying 近く or giving no distance assessment: this creates a false expectation that harms the guest experience more than accurate information would. Another common mistake is sometimes use 遠い (tooi, the adjective) where 遠くに (the adverb/locative phrase) is needed, producing grammatically awkward sentences when describing where something is located. When using 遠くに, staff should follow up with an alternative (transport options, shuttle services, taxi assistance) so the response remains helpful.
...
**Guest asks: "Is the station close?" (It is far.) Best response?**

- A. 遠くにございます (it is far away)
- B. 近くにございます (it is nearby)
- C. 隣です (it is next door)
- D. 奥です (it is at the back)

**Correct Answer:** 遠くにございます (it is far away)

**Explanation:** When a destination is far, saying 遠くにございます is the honest and respectful response, because giving a false 近く creates a worse experience when the guest arrives late or frustrated. Always pair it with a practical transport suggestion so the answer stays helpful rather than discouraging.
