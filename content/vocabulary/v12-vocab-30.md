...
---
落ち着いてください means "please stay calm" or "please compose yourself," and it is an important phrases a hotel staff member can command during a crisis. The verb 落ち着く (ochitsuku) means to settle, to calm down, or to become composed, and the kudasai form makes it a polite but clear request. In emergency situations such as a fire alarm, an earthquake, or a medical incident involving another guest, panic is one of the greatest threats to safety, it can lead to stampedes, poor decision-making, and failure to follow evacuation routes. A staff member who can deliver 落ち着いてください in a calm, authoritative, and compassionate tone performs a critical psychological function, acting as an anchor for frightened guests. The phrase is most effective when accompanied by a steady voice, deliberate eye contact, and a gesture that physically slows the interaction.

落ち着いてください is rarely used alone, it is typically preceded by a brief acknowledgment of the guest's distress and followed by concrete guidance. For example: ご安心ください、スタッフが対応しております。落ち着いてこちらへお進みください (Please be reassured, staff are handling the situation. Please calmly proceed this way). This structure acknowledges the emotion, provides reassurance, and offers a clear next step, all of which help the guest transition from panic to compliance. Staff should practice delivering this phrase with genuine calm, as a nervous or hurried delivery undermines the message. Regular emergency simulation training builds the composure staff need to be effective\n## Example Sentences
...
A critical mistake is delivering 落ち着いてください in a rushed, anxious, or loud voice: the words request calm, but the delivery must model it. If staff sound nervous, guests will mirror that anxiety rather than settle. Another error is using 落ち着いて without the polite ください ending in a formal hotel context, which sounds abrupt and potentially dismissive. Learners should also avoid following the phrase immediately with a flood of information: give the guest a moment to absorb the request to calm down before layering on evacuation instructions, as an overloaded panicking person will retain very little of what is said.
...
**A guest panics during an evacuation. What phrase should you use to help them?**

- A. 注意 (caution / attention)
- B. 落ち着いてください (please calm down)
- C. 危険 (danger)
- D. 応急処置 (first aid)

**Correct Answer:** 落ち着いてください (please calm down)

**Explanation:** 落ち着いてください is a direct, polite request to compose oneself, and it works because a calm staff member delivering it with a steady voice models the behaviour they are asking for, giving a frightened guest something human to anchor to. 注意 and 危険 are hazard-level labels that heighten awareness of risk rather than reducing panic, while 応急処置 is a physical first-aid action, not a verbal calming tool.
