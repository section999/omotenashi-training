...
**2.** 特典のスパ利用は、ご滞在中に一度お使いいただけます。
*Tokuten no supa riyou wa, go-taizai-chuu ni ichido o-tsukai itadakemasu.*
"The spa access perk can be used once during your stay."

**3.** 会員様限定の特典として、お部屋のアップグレードをご用意しております。
...
**このプランの____はスパ利用です。
(The perk of this plan is spa access.)**

- A. 特典 (benefit / privilege)
- B. 割引 (discount)
