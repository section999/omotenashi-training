...
Watch out for mixing up the noun 表示 and the verb 表示する (hyouji suru, to display / to show). The sentence structure shifts depending on which form you need, so check what role the word is playing before you write or say it. Another mistake is using 表示 generically when a more specific term is available and clearer. If the sign in question is a 非常口 sign, say 非常口の表示 or simply 非常口 — the specificity helps the guest find exactly what they are looking for. Whenever you tell a guest 表示に従ってください, pair it with a gesture toward the first visible sign in that direction. Without that starting point, the instruction is technically correct but practically incomplete.

---

## Quiz

**Guest asks: "How do I find the restroom?"**

- A. 表示に従ってください (please follow the sign)
- B. 入口です (it is the entrance)
- C. 正面です (it is the front)
