...
Staff sometimes top up シャンプー while overlooking コンディショナー or ボディーソープ sitting right next to it. The full amenity set should be checked together, not one item at a time. When a guest mentions a hair or skin allergy, staff should never guess at ingredient information: they should offer to retrieve the product packaging or check with a supervisor. シャンプー and 石鹸 are also distinct products, and guests will notice if the wrong one is brought.
...
**お部屋のバスルームには____をご用意しております。
(Shampoo is provided in your room's bathroom.)**
