...
**Register:** Neutral — used freely by both staff and guests. While キャンセル itself is a casual loanword, it must be embedded in polite grammatical structures when used by hospitality staff. In formal writing or official communications, the Japanese term 取り消し (torikeshi) may appear, but キャンセル is universally understood and appropriate in spoken hotel contexts.
...
**Which sentence is most natural and polite for confirming a cancellation?**

- A. キャンセルする？ (will you cancel?)
- B. ご予約をキャンセルされますか (would you like to cancel your reservation?)
- C. キャンセルです (it is a cancellation)
- D. キャンセルね (cancellation (casual))
