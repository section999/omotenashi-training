...
- A. "I'm not sure: you should check online."
- B. Recommend the nearest convenient spot, regardless of current bloom status
- C. Say the blossoms are beautiful without confirming current conditions
- D. Quickly check with a colleague or confirm the current status before advising, then give a specific recommendation with timing guidance
