...
Elderly guests often have specific needs that may not be communicated directly. Staff should anticipate and address these without drawing attention to any limitation:

- **Mobility**: Know where the lifts are and which routes avoid stairs. Offer guidance proactively.
- **Pace**: Slow service to match the guest's pace. Do not rush check-in or move ahead of an elderly guest.
- **Communication**: Speak clearly, at a moderate pace, facing the guest. Do not redirect communication to accompanying family members unless the elderly guest signals that preference.
