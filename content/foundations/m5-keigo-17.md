...
id: m5-keigo-17
section: 17
title: The ご Prefix, Exceptions, and Loanwords
---

This lesson covers ご and the two important exceptions to the お/ご rule: Chinese-origin words that always take お, and loanwords that take no prefix at all.
...
Loanwords (外来語) from English and other languages never take お or ご. Adding a prefix to a loanword sounds incorrect in any context.
...
<span class="keigo-badge bad">Wrong</span> Loanwords (外来語) never take お or ご.
</div>
<div class="good-col">
...
<span class="keigo-badge good">Correct</span> Use the loanword as-is; build keigo around the sentence structure.
</div>
</div>
...
**Explanation:** 部屋 is a native Japanese word (和語), so it takes お; option D is correct. Option A incorrectly applies ご to 部屋. Option B incorrectly applies お to 予約, a 漢語 word that takes ご. Option C incorrectly applies ご to 電話, which is a fixed exception that always uses お in hotel service.
