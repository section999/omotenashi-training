...
**A staff member receives a phone call from a guest in Room 310 reporting that the room key has stopped working. The staff member needs to inform the front desk supervisor. Which standard is most directly relevant here?**

- A. Standard 4: use functional internal language rather than guest-facing keigo
- B. Standard 2: state the conclusion first, then the supporting detail
- C. Standard 5: never delay a report to solve the problem first
- D. Standard 3: include who, what, when, and next step

**Correct Answer:** B

**Explanation:** When reporting the key card failure to a supervisor, the most important standard to apply is conclusion first: state immediately that Room 310's key card is not functioning, then add the context (guest called to report it, guest is currently unable to enter). Standard 2 ensures the supervisor can act without having to wait through background information. While Standard 3 and Standard 4 are also relevant to good internal communication generally, the specific skill tested here is the structure of the report itself.
