...
id: m5-keigo-28
section: 28
title: Errors 3 and 4: Double Keigo and Register Mixing
---

These two errors both involve inconsistency: Error 3 stacks too much keigo in a single verb, while Error 4 mixes registers across a single sentence.

## Error 3: Double Keigo (過剰敬語)

Double keigo means stacking two humble forms on top of each other. This creates an unnatural expression that sounds excessive rather than polished.
...
- D. させていただく should be replaced with くださいませ

**Correct Answer:** C

**Explanation:** お伺いします is already a fully humble 謙譲語 form. Adding させていただく (another humble expression meaning "to be permitted to do") creates double keigo that sounds excessive and unnatural. The correct form is 「お伺いいたします」, using one humble layer (お伺い) plus the polished auxiliary いたします. Hotel keigo requires one keigo form per verb; stacking two humble forms signals an attempt at politeness that has overshot the mark.
