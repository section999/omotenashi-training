...
In a hospitality context, keigo tells the guest that they are valued, respected, and treated as a person of significance. Using incorrect or casual language, even unintentionally, can undermine an otherwise excellent service experience. Fluent, natural keigo creates an immediate atmosphere of care and professionalism.
...
<span class="keigo-badge info">Sonkeigo (尊敬語)</span> Respectful language. Used to elevate the guest's actions and status.<br>&nbsp;&nbsp;• E.g., *お召し上がりになりますか？* (Will you be dining?)<br><br><span class="keigo-badge info">Kenjōgo (謙譲語)</span> Humble language. Used to lower the speaker's own actions, showing deference.<br>&nbsp;&nbsp;• E.g., *ご案内いたします。* (I will show you to your room.)<br><br><span class="keigo-badge info">Teineigo (丁寧語)</span> Polite language. Everyday formal speech using です and ます forms.<br>&nbsp;&nbsp;• E.g., *こちらがお部屋でございます。* (This is your room.)
</div>
