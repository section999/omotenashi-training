...
The most common failure in kuuki wo yomu is defaulting to a single mode regardless of the guest — either always talkative and warm (which irritates private guests) or always efficient and minimal (which disappoints guests seeking connection). Excellent hospitality is calibrated to each person.

This skill cannot be scripted. It is developed through genuine interest in the people in front of you, careful observation, and the willingness to adjust in real time.
...
- A. The guest is rude and should be served with minimal warmth
- B. The guest is likely tired, stressed, or in a hurry — serve efficiently and warmly, minimise unnecessary conversation
