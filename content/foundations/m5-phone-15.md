...
id: m5-phone-15
section: 15
title: Hold Management and Callback Procedures
---

Holds and callbacks are moments where the guest has no visibility into what is happening. Silence creates anxiety. A vague promise creates uncertainty. This lesson covers how to manage both with language that keeps the guest informed and confident.
...
The guest should never feel that responsibility for their request has disappeared. Whether they are placed on hold or promised a callback, the hotel must feel like a single, organized entity. The guest's request does not get "passed"; it gets "coordinated."

Every hold and callback is a test of whether the hotel operates as one system or as disconnected departments.

---

## Quiz

**When offering a callback to a guest, what must always be included?**

- A. The staff member's personal name
- B. A specific time frame for the callback, such as "within 30 minutes"
- C. A detailed explanation of why the specialist is unavailable
- D. An apology for calling in the first place

**Correct Answer:** B

**Explanation:** "We will call you back" without a specific time frame creates uncertainty. Stating "within 30 minutes" (30分以内にご連絡いたします) creates a commitment the guest can rely on. Vague promises fail the principle of continuity of responsibility because the guest has no clear expectation to hold the hotel accountable to.
