...
id: m5-meeting-03
section: 3
title: Essential Handover Vocabulary
---

Hotel handover notes use a specialized set of operational terms. These are not formal keigo expressions. They are status labels and category words that communicate condition and responsibility efficiently. Every staff member must know them before reading or writing a shift note.
...
**A guest has asked for extra pillows but the request has not been fulfilled yet. Which status label is correct?**
...
**Explanation:** 未対応 means "not yet handled", a request has been received but no action has been taken. This is the correct label for a request that exists but has not been fulfilled. 対応済み and 完了 both indicate the task is done. 保留 means the task is on hold, which implies a specific reason for the pause (awaiting a decision or information). If the task simply has not been started, 未対応 is the precise term.
