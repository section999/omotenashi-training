...
The most impressive hospitality often happens before any guest interaction takes place. The room that is perfectly prepared, the table that reflects a remembered preference, the lobby that feels welcoming the moment you walk in — these are the result of skilled, attentive preparation that the guest will never see, but will always feel.
...
Perhaps the most important preparation tool is the team briefing. Information about today's guests — their needs, preferences, the purpose of their stay, any sensitivities — must be shared across all functions. A dietary restriction that lives only in the restaurant reservation system but does not reach the kitchen is not managed; it is a liability.

Information flows, and the quality of that flow is the quality of your preparation.
...
- A. Confirm the booking is in the system; prepare the room in standard configuration
- B. Assign a high-floor room, brief the kitchen and F&B team about the nut allergy, arrange a welcome gift or special touch in the room acknowledging the occasion, ensure all staff in contact with the guest today are aware of the allergy
...
**Explanation:** Proactive preparation means acting on known information before the guest arrives. A nut allergy is a safety issue that must reach the kitchen before the first meal — not be disclosed at the table. A honeymoon is an emotional milestone that deserves acknowledgement. A high-floor preference should be met without being asked. All three require preparation, not reaction.
