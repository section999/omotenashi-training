...
| Step Skipped | Risk Created |
|---|---|
| Recognition | Staff may handle the wrong request entirely |
| Confirmation | Booking errors from misheard names or dates |
| Action explanation | Guest becomes anxious during unexplained silence |
...
**Which step of the 7-step structure prevents guest anxiety during a system check?**
...
**Explanation:** The Action step (確認いたしますので少々お待ちくださいませ) tells the guest exactly what is happening during the wait. Without this narration, the guest hears silence and becomes anxious, not knowing if the call is still active or whether the request is being processed. Never leave silence unexplained.
