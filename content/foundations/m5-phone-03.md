...
<em>shouchi itashimashita</em><br>
Understood (formal; used when receiving information the guest provides)<br><br>
<span class="keigo-jp"><code>さようでございますか</code></span><br>
<em>sayou de gozaimasu ka</em><br>
Is that so? (formal empathetic response; shows you are listening closely)
</div>
...
I will confirm (always precede a hold with this phrase)<br><br>
<span class="keigo-jp"><code>大変お待たせいたしました</code></span><br>
<em>taihen o-matase itashimashita</em><br>
Thank you very much for waiting (use when returning after any wait)
</div>
...
<em>tantousha ni o-tsunagi itashimasu</em><br>
I will connect you to the person in charge<br><br>
<span class="keigo-jp"><code>折り返しご連絡いたします</code></span><br>
<em>orikaeshi go-renraku itashimasu</em><br>
