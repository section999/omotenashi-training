...
id: m5-internal-11
section: 11
title: Reporting Your Own Mistakes
---
...
**A staff member discovers they made an error during the morning shift. The error has potentially already affected a guest's experience. What should they do?**

- A. Wait until the end of the shift to include it in the handover notes, so as not to disrupt the supervisor
- B. Try to fix the error quietly without informing anyone, to avoid drawing attention to the mistake
- C. Report the error immediately to their supervisor, stating what happened, the current impact, any steps already taken, and ask for guidance
- D. Apologize to the supervisor repeatedly before explaining the situation

**Correct Answer:** C

**Explanation:** When an error has potentially already had an effect on a guest, immediate reporting is required. The report should follow the four-part structure: what happened, current impact, steps already taken, and a request for guidance. Option A delays the supervisor's ability to act by hours, potentially allowing the impact to grow. Option B withholds information the supervisor needs; quietly fixing a problem without reporting it means the supervisor cannot manage the floor with full information. Option D prioritizes the apology over the information transfer, which delays resolution.
