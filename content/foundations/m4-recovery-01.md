...
A team that understands this does not dread complaints. They receive them as the valuable information they are: an indication of exactly where the guest's experience fell short of their expectation, and an opportunity to demonstrate what the establishment is truly capable of when it must rise to a challenge.
...
Each of these steps will be explored in the lessons that follow.
