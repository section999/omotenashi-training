...
VIP guests often have needs that fall outside standard procedures — and they expect those needs to be met without being made to feel that they are causing trouble. The ability to fulfil unusual requests gracefully, and without visible effort, is one of the hallmarks of elite hospitality.

**The preparation mindset:**

Before a VIP guest arrives, review everything available: past stay records, any preferences communicated by the guest or their team, public information about their work and schedule. Then ask: *What might they need that they have not yet asked for?*
...
When a request falls outside what the property can provide directly, the correct response is not *"I'm sorry, we don't offer that."* It is:
*"Leave it with me — I will look into the best way to arrange that for you."*
...
Requests that are illegal, harmful, or deeply unethical are declined firmly and without apology. The property's integrity is not negotiable, regardless of the guest's status. A calm, respectful refusal — without explanation beyond necessity — is the correct approach.
