...
However, hotel language should not feel:

- overly stiff,
- excessively complicated,
- or difficult to read.

The best hotel communication balances:
...
An important rule is consistency. The email should maintain the same tone from beginning to end.

Sudden changes in formality can make the message sound unnatural.
