...
Japanese communication style is often described as *high-context* — meaning that much of the message is conveyed through context, relationship, and implication rather than explicit words. Silence is a tool, not a gap.
...
A guest who goes quiet after receiving information — a price, a wait time, a policy — may be displeased but unwilling to say so directly. Watch for accompanying signals: the slight intake of breath, the downward glance, the brief lip compression.
...
When you sense indirect dissatisfaction, do not confront it directly. Instead, offer an alternative:

> "We also have a room closer to the elevator — would that be more convenient?"

This gives the guest a face-saving way to change their mind without admitting dissatisfaction.
...
- A. Repeat the recommendation more clearly
- B. Ask directly "Do you not like it?"
...
**Explanation:** "ちょっと..." is a soft, indirect signal of hesitation or rejection. The correct approach is to offer an alternative that gives the guest a comfortable way forward without losing face.
