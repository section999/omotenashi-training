...
| あげる (ageru) | さしあげる (sashiageru) | to give |
| 言う (iu) | 申す (mōsu) | to say |
| いる (iru) | おる (oru) | to be (oneself) |
...
- A. Describing the guest's action respectfully
- B. Lowering the speaker's own action as a sign of deference
- C. Indicating a request from the guest
