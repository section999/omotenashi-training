...
At the VIP level, the acceptable time between a problem being identified and action being taken is measured in minutes, not hours. The moment a staff member becomes aware of an issue involving a VIP guest, it escalates immediately: to the duty manager if minor, to the general manager if significant.

No individual staff member should decide alone whether an issue involving a VIP guest is serious enough to escalate. When in doubt, escalate.
...
The gesture must be proportionate and personal. A bottle of champagne offered to a guest who does not drink is worse than no gesture at all. Review what is known about the guest and respond to that specific person. A generic gift signals that you did not pay attention.

## The After-Action Review

Once the guest has departed, conduct an internal review. Identify what failed, why it happened, and what would prevent a recurrence. The recovery is not complete until the system has actually been improved.
