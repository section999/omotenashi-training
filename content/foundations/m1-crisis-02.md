...
The LEARN protocol provides a structured approach to complaint resolution that ensures nothing critical is missed, while remaining flexible enough to feel natural rather than scripted. Used well, it guides the interaction without making the guest feel that they are being processed through a system.
...
• Face the guest directly<br>• Maintain appropriate eye contact<br>• Keep your body still and open<br>• Do not fidget, check the time, or glance at colleagues
</div>
...
- A. Negotiate: reaching a compromise solution that satisfies both the guest and the property
- B. Notify: following up personally with the guest to confirm the resolution was satisfactory
